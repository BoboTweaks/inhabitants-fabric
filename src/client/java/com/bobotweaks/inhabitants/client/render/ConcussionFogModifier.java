...
public class ConcussionFogModifier extends FogModifier {

    @Override
    public boolean shouldApply(@Nullable CameraSubmersionType submersionType, Entity cameraEntity) {
        return ConcussionEffectHandler.muffleLerp > 0.0f;
    }
    ...
    public void applyStartEndModifier(
        ...
        float intensity = ConcussionEffectHandler.muffleLerp;
